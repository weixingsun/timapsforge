use autojar to remove unused classes

java -jar autojar-2.1/autojar.jar -o trove4j-stripped.jar -c $TROVE/target/classes @trove-class.list

/cygdrive/c/ProgramData/Titanium/mobilesdk/win32/4.1.0.GA/timapsforge_graphhopper/timapsforge/lib_0.5.1
